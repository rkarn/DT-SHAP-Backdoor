...
- Then we apply SHAP to extract the explainabiity where the backdoor trigger label(label 5) plots are extracted and compared with the prediction made by clean data for same inference label (label 0).
